...
def setup_all_datasets(dataset_dir, image_root_corruption_prefix=None):
    ...
    setup_env_ood_dataset(dataset_dir)
...
def setup_env_ood_dataset(dataset_dir):
    train_image_dir = os.path.join(dataset_dir, 'OoD_folder', 'images', 'train2017')
    val_image_dir = os.path.join(dataset_dir, 'OoD_folder', 'images', 'val2017')

    # test_json_annotations = os.path.join(
    #     dataset_dir, 'COCO-Format', 'val_coco_format.json')
    train_json_annotations = os.path.join(
        dataset_dir, 'OoD_folder', 'annotations', 'instances_train2017.json')
    val_json_annotations = os.path.join(
        dataset_dir, 'OoD_folder', 'annotations', 'instances_val2017.json')
    ...
    # import ipdb; ipdb.set_trace()
    MetadataCatalog.get(
        "env_ood_train").thing_classes = metadata.ENV_OOD_THING_CLASSES
    MetadataCatalog.get(
        "env_ood_train").thing_dataset_id_to_contiguous_id = metadata.ENV_OOD_THING_DATASET_ID_TO_CONTIGUOUS_ID
    ...
    MetadataCatalog.get(
        "env_ood_val").thing_classes = metadata.ENV_OOD_THING_CLASSES
    MetadataCatalog.get(
        "env_ood_val").thing_dataset_id_to_contiguous_id = metadata.ENV_OOD_THING_DATASET_ID_TO_CONTIGUOUS_ID
