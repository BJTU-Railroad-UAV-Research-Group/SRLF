...
# ENV_OOD_THING_CLASSES = ['Stone', 'Landslip', 'Flood', 'Animal', 'DebrisFlow', 'Floater']
ENV_OOD_THING_CLASSES = ['OOD']
ENV_OOD_THING_DATASET_ID_TO_CONTIGUOUS_ID = dict(
    ChainMap(*[{i + 1: i} for i in range(1)]))
...
VOC_THING_CLASSES =  ['Railroad', 'Car', 'CementRoom', 'ColorSteelTile', 'IronSheetRoom', 'PlasticFilm', 'AsbestosTile', 'Rubbish']
# ['person',
#                      'bird',
#                      'cat',
#                      'cow',
...
#                      'tv',
#                      ]
VOC_ID_THING_CLASSES = ['Railroad', 'Car', 'CementRoom', 'ColorSteelTile', 'IronSheetRoom', 'PlasticFilm', 'AsbestosTile', 'Rubbish']
# [
